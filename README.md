...
## Skill Builder 4 - Decisions, Decisions, Decisions ...</h2>
...
<strong>IMPORTANT</strong>: Use the string method <code>equalsIgnoreCase</code>.  For example, if you have a string variable called `month` and you want to see if it is equal to "thursday", ignoring case, then
</p>
